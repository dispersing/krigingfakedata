#############################################################
#                                                           #
#          SIMPLE EXAMPLE OF KRIGGING SPATIAL DATA          #
#                                                           #
#                         ~INDEX~                           #
# 1. load libraries
# 2. make-and-fake x-y data (I made bimodal disttributions)
# 3. make sure it looks bimodal *alone*
# 4. make sure it looks bimodal *together*
# 5. add some values to the x and y points
# 6. krig it
# 7. see how long it will take to increase pixels (hint: it's exponential)
# 8. fit an exponential equation to the dta and plot it
